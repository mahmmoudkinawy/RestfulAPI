...
namespace CourseLibrary.API.Controllers
{
    ...
    public class CoursesController : ControllerBase
    {
        ...
        public ActionResult<CourseDto> GetCourseActionForAuthor(Guid authorId, Guid courseId)
        {
            if (!_courseLibraryRepository.AuthorExists(authorId)) return NotFound();

            var courseForAuthorFromCamp = _courseLibraryRepository.GetCourse(authorId, courseId);

            if (courseForAuthorFromCamp == null) return NotFound();

            return Ok(_mapper.Map<CourseDto>(courseForAuthorFromCamp));
        }
            ...
            CourseForUpdateDto course)
        {
            ...
            if (courseForAuthorFromRepo == null)
            {
                ...
                return CreatedAtRoute("GetCourseForAuthor",
                    new { authorId, courseId = courseId },
                    courseToReturn);
            }
        ...
        public ActionResult DeleteCourseForAuthor(Guid authorId, Guid courseId)
        {
            ...
            if (courseFromAuthorRepo == null) return NotFound();
